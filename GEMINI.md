# Gemini Developer Guide — Palantir Bots

Welcome to the development guide for **Palantir Bots**. This file contains crucial context for AI coding agents and human developers on how the codebase operates, how data is managed, and how to safely extend the bot.
...
Palantir Bots uses a strict, tiered command registry:
