...
export async function addStickerMetadata(webpBuffer, packName = settings.stickerPackName || 'Palantir Bot Stickers', author = settings.stickerAuthor || 'Pentagon') {
    try {
        ...
        const json = {
            'sticker-pack-id': `palantirbots-${Date.now()}`,
