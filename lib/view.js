...
export function getUserMenu() {
    const activePrefix = db.data.settings.prefix || settings.prefix;
    return `
${getHeader('User Menu', activePrefix)}
│ ${activePrefix}help
│ ${activePrefix}usermenu
│ ${activePrefix}ping
...
export function getPremiumMenu() {
    const activePrefix = db.data.settings.prefix || settings.prefix;
    return `
${getHeader('Premium Menu', activePrefix)}
│
├─  *Downloader*
...
export function getOwnerMenu() {
    const activePrefix = db.data.settings.prefix || settings.prefix;
    return `
${getHeader('Owner Menu', activePrefix)}
│
├─  *System / Bot Control*
│ ${activePrefix}addbot
│ ${activePrefix}delbot
