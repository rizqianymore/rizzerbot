                ...
                if (isImage && text.trim()) {
                    try {
                        ...
                        const drawMemeText = (txt, isTop) => {
                            ...
                            let fontSize = Math.floor(img.width * 0.075); // base font size 7.5% of width (smaller/more precise)
                            let lines = [];
                            let lineHeight = 0;
                            ...
                            ctx.lineWidth = Math.max(2.5, fontSize * 0.12); // thinner and cleaner stroke
                            ctx.lineJoin = 'round';
