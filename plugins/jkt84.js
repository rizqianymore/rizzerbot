...
const localMembersList = [
    "Abigail Rachel", "Adeline Wijaya", "Afera Thalia", "Alya Amanda", "Angelina Christy",
    "Anindya Ramadhani", "Astrella Virgiananda", "Aulia Riza", "Aurellia", "Aurhel Alana",
    "Bong Aprilli", "Carissa Dini", "Catherina Vallencia", "Cathleen Nixie", "Celline Thefani",
    "Chelsea Davina", "Christabella Bonita", "Cornelia Vanisa", "Cynthia Yaputera",
    "Dena Natalia", "Desy Natalia", "Fahira Putri", "Fatimah Azzahra", "Febriola Sinambela",
    "Feni Fitriyanti", "Fiony Alveria", "Freya Jayawardana", "Fritzy Rosmerian",
    "Gabriela Abigail", "Gendis Mayrannisa", "Gita Sekar Andarini", "Grace Octaviani",
    "Greesella Adhalia", "Hagia Sopia", "Heidi Suyangga", "Helisma Putri", "Hillary Abigail",
    "Humaira Ramadhani", "Indah Cahya", "Isha Kirana", "Jacqueline Immanuela", "Jazzlyn Trisha",
    "Jemima Evodie", "Jessica Chandra", "Jesslyn Elly", "Kathrina Irene", "Lulu Salsabila",
    "Marsha Lenathea", "Maura Nilambari", "Maxine Faye", "Michelle Alexandra", "Michelle Levia",
    "Mikaela Kusjanto", "Mutiara Azzahra", "Nayla Suji", "Nina Tutachia", "Nur Intan",
    "Oline Manuel", "Pia Meraleo", "Putry Jazyta", "Raisha Syifa", "Ralyne Van Irwan",
    "Ribka Budiman", "Sami Maono", "Shabilqis Naila", "Sona Kalyana", "Tana Nona",
    "Victoria Kimberly"
];
...
export default {
    ...
    run: async (sock, msg, args, { sendTyping }) => {
        ...
        try {
            ...
            const detailRes = await axios.get(`https://jkt48.com/api/v1/members/${memberId}?lang=id`, { timeout: 5000 });
            ...
            if (details.birth_date) {
                try {
                    birthDateStr = new Date(details.birth_date).toLocaleDateString('id-ID', {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric'
                    });
            ...
            const photoUrl = details.photo_1 || details.photo_2 || details.photo || targetMember.photo;
            ...
            if (photoUrl) {
                try {
                    ...
                    console.error('Error sending JKT48 image, falling back to text:', imgError);
                    await sock.sendMessage(msg.key.remoteJid, { text: detailsText }, { quoted: msg });
                }
            } else {
                await sock.sendMessage(msg.key.remoteJid, { text: detailsText }, { quoted: msg });
            }
            ...
            const fallbackText = `⚠️ *API JKT48 sedang gangguan. Menampilkan data lokal:*\n\n` +
                `• *Nama:* ${localName}\n\n` +
                `🔗 Info: ${googleSearch}`;
